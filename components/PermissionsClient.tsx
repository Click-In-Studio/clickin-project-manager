...
const PERMISSION_LABELS: Partial<Record<Permission, string>> = {
  ...
  // 事件
  "event:modify_published": "修改已发布事件",
  "event:revoke": "撤销事件",
  "event:delete": "删除事件",
  ...
  "event:edit": "编辑事件",
  "event:publish": "发布事件",
  "event:create_schedule": "创建子事件",
  "event:edit_schedule": "编辑子事件",
  "event:delete_schedule": "删除子事件",
  "event:assign_participants": "绑定参与人员",
  "event:assign_schedule_participants": "绑定子事件参与人员",
  ...
  "event:view": "查看事件",
  "event:view_call_sheet": "查看Call Sheet",
  "event:view_call_sheet_any": "查看他人Call Sheet",
  "event:view_tech_req": "查看技术需求",
  "event:view_tech_req_any": "查看他人技术需求",
  "event:follow": "关注事件",
  // 报告
  "report:modify_published": "修改已发布报告",
  "report:revoke": "撤销报告",
  "report:create": "创建报告",
  "report:edit": "编辑报告",
  "report:publish": "发布报告",
  "report:delete": "删除报告",
  "report:create_note": "创建记录",
  "report:edit_note": "编辑记录",
  "report:delete_note": "删除记录",
