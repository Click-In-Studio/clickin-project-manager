...
import React, { useCallback, useEffect, useLayoutEffect, useMemo, useRef, useState, type DragEvent, type KeyboardEvent } from "react";
...
import ProductionTopMenu, { ProductionOverflowSubmenuButton, ProductionTopMenuDivider, PRODUCTION_TOP_MENU_RIGHT_CLASS, PRODUCTION_TOP_MENU_SLOT_ID, PRODUCTION_TOOLBAR_STAGE, useAnchoredMenu, useProductionToolbar, useProductionToolbarStage } from "@/components/shell/ProductionTopMenu";
...
import { sameDragTarget, resolveDragTarget, getDragInsertIndex, type DragTarget, type BlockDragTarget } from "@/lib/script/script-drag-target";
...
import { computeLyricFromTags, sceneDetailDeleteBlockedMessage, markerBlockDramaturgyDeleteBlockedKind, markerDetailFields, markerExpectedDuration, buildOrderedTocScenes, toSceneDetail, syncSceneDetailsWithScenes, sameSceneRows, type SceneMetaFields, type MarkerDetailDeleteBlockedKind, type NonEmptyDramaturgyMarker, type MarkerDetailField } from "@/lib/script/script-scene-details";
...
import { DEFAULT_SCRIPT_CONFIG, type Block, type BlockType, type Character, type Scene, type ScriptState, type ScriptConfig, type ScriptTextLayoutMode } from "@/lib/script/script-types";
import { TOOLBAR_FOLD_HYSTERESIS_PX, COMPACT_STAGE_COMMENT_EDITOR_WIDTH_RATIO, LINE_INDEX_GUTTER_OFFSET_REM, LINE_INDEX_CONTROL_MIN_WIDTH_REM, SCRIPT_TOC_CENTER_EVENT, SCRIPT_EDITOR_MAX_WIDTH_PX, SCRIPT_BODY_HORIZONTAL_PADDING_REM, SCRIPT_PRODUCTION_SIDEBAR_FULL_WIDTH_PX, SCRIPT_CONTENTS_MENU_MAX_WIDTH_REM, SCRIPT_TOC_RAIL_SCROLLBAR_WIDTH_REM, SCRIPT_TOC_RAIL_COMPACT_NUMBER_PADDING_REM, SCRIPT_TOC_RAIL_NUMBER_SLOT_REM, SCRIPT_TOC_RAIL_LABEL_GAP_REM, SCRIPT_TOC_RAIL_SUBSCENE_INDENT_REM, SCRIPT_SCENE_DETAIL_RAIL_MIN_WIDTH_REM, SCRIPT_SCENE_DETAIL_RAIL_MAX_WIDTH_PX, SCRIPT_SCENE_DETAIL_RAIL_RIGHT_INSET_PX, SCRIPT_SCENE_DETAIL_MODE_BUTTON_EXTRA_INSET_REM, SCRIPT_SCENE_DETAIL_CAPTION_BG_HEIGHT_REM, SCRIPT_SCENE_DETAIL_MODE_LABEL, SCRIPT_TOC_ACTIVE_SCENE_TOP_ANCHOR_PX, REHEARSAL_MARKER_ROW_BASE_HEIGHT_REM, REHEARSAL_MARKER_ROW_HEIGHT_SCALE, REHEARSAL_MARKER_ROW_MIN_HEIGHT_PX, REHEARSAL_MARKER_FLOAT_LEFT_OFFSET_REM, MARKER_CONTROL_DELETE_LEFT_PX, MARKER_CONTROL_BAR_LEFT_PX, MARKER_CONTROL_TRIANGLE_LEFT_PX, MARKER_CONTROL_TRIANGLE_TOP_OFFSET_PX, MARKER_DIVIDER_RIGHT_MARGIN, anchoredManagementPanelStyle, DISABLED_CHECKBOX_OPTION_CLASS, checkboxOptionClass, COMMENT_BUBBLE_MIN_WIDTH_PX, COMMENT_BUBBLE_GAP_REM, SPEECH_TAIL_PIN_OFFSET_PX, SPEECH_TAIL_BASE_HALF_PX, SPEECH_TAIL_EDGE_INSET_PX, SIDE_PANEL_TOP_PX, SIDE_PANEL_FALLBACK_WIDTH_PX } from "./script-editor/constants";
...
import { isAtStart, isOnFirstLine, isOnLastLine, getHtmlSplit, setCursorAtStart, setCursorAtEnd, setCursorAtTextOffset, getEditableElementForRange, isTextEditingTarget, isFormEditingTarget, getTextLength } from "./script-editor/dom-cursor";
...
import { sanitizePasteHtml, htmlToMd, replaceInlineStageDelimiters, toggleInlineTag, wrapSelectionAsInlineStageCue, applyInlineStageStyling } from "./script-editor/inline-stage";
