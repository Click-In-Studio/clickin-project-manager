...
const PERM_GROUPS: PermGroup[] = [
  ...
  { label: "报告", perms: ["report:create", "report:create_note_any", "report:edit_note_any", "report:delete_note_any"] },
  ...
  { label: "读权限", perms: ["contacts:view", "script:view", "script:comment", "scene:view", "character:view", "cue_list:view", "cue:view", "cue:comment", "event:view_call_sheet_any", "event:view_tech_req", "event:view_tech_req_any", "event:follow", "report:reply", "note:comment", "asset:view", "asset:download", "asset:download_any", "asset:share", "asset:share_downloadable", "asset:share_any", "asset:share_any_downloadable", "org:assign_member", "org:recall_member"] },
];
