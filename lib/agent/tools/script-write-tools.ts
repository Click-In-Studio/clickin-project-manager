...
import type { GrantActor } from "@/lib/perm/grant-check";
import { canAccessNodesBatch, formatNodeKey, type NodeAccessResult, type NodeKeyParts } from "@/lib/perm/grant-template";
import { getActiveVersionId, loadProduction, applyPatchToDB } from "@/lib/db";
import { tickAndBroadcastSeq } from "@/lib/server-cache";
import { diffState, requiredPermissions, type ScriptPermissionKey, type ScriptPatch } from "@/lib/script/script-ops";
