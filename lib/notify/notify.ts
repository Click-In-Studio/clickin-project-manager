...
import { renderNotifyDoc } from "./doc/from-markdown";
import { createNotifyRefResolver } from "./doc/resolver";
import { toSummary } from "./doc/platform-text";
import { toLarkMd } from "./doc/platform-feishu";
import { toEmailHtml } from "./doc/platform-html";
import { truncateDoc } from "./doc/ast";
 ...
 * 退出必须是有声的——不存在「悄悄退出」。
 *
 * 收件人是 lib/perm/member-exit-routing 的阶梯（直属上级链 → 制作人 → owner），
