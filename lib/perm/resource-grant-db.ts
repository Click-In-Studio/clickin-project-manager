...
import type { TaskSubject } from "../ops/task-poc";
 ...
 */
/**
 * task 的责任主体已泛化为「部门 | 用户组」（见 lib/ops/task-poc.ts 的 TaskSubject）。
 *
 ...
 * 走 lib/ops/task-poc.ts 的 Type B 上下文判定，部门换 POC / 组换 POC 都自动跟随，
 * 不依赖这里补写任何行。
 */
