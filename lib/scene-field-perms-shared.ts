...
export type SceneFieldPerms = Record<SceneField, boolean> & {
   ...
   *  `resource_id IN (sceneId, '*')`，而字段 PATCH 只查 '*'，故只有 delete 有这一层。 */
  deleteIds: string[];
  /** 结构面：重排、归属变更 */
  structure: boolean;
  any: boolean;
...
export const ALL_SCENE_FIELD_PERMS: SceneFieldPerms = {
  ...
  create: true, delete: true, deleteIds: [], structure: true, any: true,
};
...
export const NO_SCENE_FIELD_PERMS: SceneFieldPerms = {
  ...
  create: false, delete: false, deleteIds: [], structure: false, any: false,
};
