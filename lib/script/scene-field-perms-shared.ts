 ...
 *
 * 与 lib/perm/member-status-shared.ts 同一约定：canDeleteScene 要在浏览器里逐行跑，
 * 而 lib/script/scene-field-perms.ts 连着 pg 进不了浏览器包。谓词只写一遍，两侧同源。
 *
 ...
 *   - lib/script/script-ops.ts                          剧本页 patch 的 marker 字段门
