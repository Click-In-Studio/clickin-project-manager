 ...
 *
 * 与 lib/perm/member-status-shared.ts 同一约定：判定用的谓词要在浏览器里跑（角色页逐行
 * 算 canEdit/canDelete），而 lib/script/character-perms.ts 连着 pg 进不了浏览器包。
 * 谓词只写一遍，两侧同源。
 *
 ...
 * 权限中心的键选择器又允许把 id 位指到具体角色（lib/perm/resource-directory.ts 里
