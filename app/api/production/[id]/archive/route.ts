...
import { archiveProduction, unarchiveProduction } from "@/lib/production/production-db";
...
async function requireManage(req: NextRequest, productionId: string, verb: "create" | "delete") {
  ...
  if (!await hasEffectiveGrant(permCtx, productionId, "production", "*", "archival", verb))
